...
| `RIPOSO_BACKOFF`                   | Provide clients with a backoff during which they should avoid unnecessary requests. | _none_                              |
| `RIPOSO_BACKOFF_PERCENTAGE`        | Send backoff header to a fraction of clients.                                       | _none_                              |
| `RIPOSO_RETRY_AFTER`               | Duration after which the client should issue requests after failures.               | `30s`                               |
